        ...
        <section aria-labelledby="faqs">
            <div class="flex flex-wrap justify-center gap-8 md:gap-x-16 max-w-2xl mx-auto">
                ...
                <div class="grid gap-5">
                    <h2 id="faqs"
                        class="mt-12 text-2xl sm:text-4xl font-bold text-amber-400 text-center">
                        FAQ'S
                    </h2>
                        ...
                        <ul class="shadow-box">
                            ...
                            <li class="relative border-b border-gray-200">
                                ...
                                <div class="relative overflow-hidden transition-all max-h-0 duration-700"
                                    ...
                                    <div class="p-6">
                                        ...
                                        <p>reCAPTCHA v3 is intended for power users, site owners that want more data
                                            about
                                            their traffic, and for use cases in which it is not appropriate to show a
                                        ...
                                        <p>For example, a registration page might still use reCAPTCHA v2 for a
                                            ...
                                            searches,
                                            comments, or voting might use reCAPTCHA v3. To see more details, see the
                                            reCAPTCHA v3 developer guide.</p>
                                    </div>
                                </div>
                            ...
                            <li class="relative border-b border-gray-200">
                                ...
                                <div class="relative overflow-hidden transition-all max-h-0 duration-700"
                                    ...
                                    <div class="p-6">
                                        <p>For reCAPTCHA v3, create a separate key for testing environments. Scores may
                                            not
                                            be accurate as reCAPTCHA v3 relies on seeing real traffic.</p>
                                        <p>For reCAPTCHA v2, use the following test keys. You will always get No CAPTCHA
                                            and
                                            all verification requests will pass.</p>
                                    </div>
                                </div>
                            ...
                            <li class="relative border-b border-gray-200">
                                ...
                                <div class="relative overflow-hidden transition-all max-h-0 duration-700"
                                    ...
                                    <div class="p-6">
                                        ...
                                        <p>You are allowed to hide the badge as long as you include the reCAPTCHA
                                            branding
                                        ...
                                        <ul>
                                            <li>First, replace &lt;script src="https://www.google.com/recaptcha/api.js"
