            ...
            <div class="h-screen bg-white transition-all duration-300 space-y-2 fixed z-20 lg:hidden"
                ...
                <div class="px-4 space-y-2">
                    ...
                    <div x-data="tooltip"
                         x-on:mouseover="show = true"
                         x-on:mouseleave="show = false"
                         @click="$store.sidebar.active = 'login' "
                         class=" relative flex items-center hover:text-neutral-900 hover:bg-amber-200 space-x-2 rounded-md p-2 cursor-pointer"
                         x-bind:class="{
                             'justify-start': $store.sidebar.full,
                             'justify-start': !$store.sidebar
                             ...
                             'text-neutral-900 bg-amber-200': $store.sidebar.active ==
                                 'login',
                             'text-gray-400 ': $store.sidebar.active != 'login'
                         }">

                        <svg xmlns="http://www.w3.org/2000/svg"
                             fill="none"
                             viewBox="-1.5 -1.5 48 48"
                             id="Login-3--Streamline-Ultimate"
                             height="24"
                             width="24">
                            <desc>Login 3 Streamline Icon: https://streamlinehq.com</desc>
                            <path fill="#e3e3e3"
                                  d="M32.8125 10.3125V5.625c0 -0.24864375 -0.0988125 -0.48710625 -0.2745 -0.6629062499999999C32.362125 4.786275 32.123625 4.6875 31.875 4.6875H17.8125v35.625H31.875c0.24862499999999998 0 0.487125 -0.0988125 0.663 -0.2745 0.1756875 -0.175875 0.2745 -0.414375 0.2745 -0.663v-4.6875"
                                  stroke-width="3"></path>
                            <path stroke="#191919"
                                  stroke-linecap="round"
                                  stroke-linejoin="round"
                            ...
                            <path stroke="#191919"
                                  stroke-linecap="round"
                                  stroke-linejoin="round"
                                  d="M21.5625 22.5h22.5"
                                  stroke-width="3"></path>
                            <path stroke="#191919"
                                  stroke-linecap="round"
                                  stroke-linejoin="round"
                                  d="m29.0625 15 -7.5 7.5 7.5 7.5"
                                  stroke-width="3"></path>
                            <path fill="#c77f67"
                                  d="M0.9375 39.791250000000005c0.000084375 0.213375 0.0729675 0.420375 0.20660625 0.5866875s0.32003625 0.2821875 0.52839375 0.3283125l15 3.33375c0.13696875 0.0301875 0.27899999999999997 0.0294375 0.4156125 -0.0024375 0.13659374999999999 -0.031875 0.26431875000000005 -0.0939375 0.37370624999999996 -0.181875 0.10940625 -0.08775000000000001 0.19770000000000001 -0.1989375 0.25839375 -0.3255 0.060693750000000005 -0.12637500000000002 0.09223125 -0.2649375 0.0922875 -0.4051875V1.87497375C17.81244375 1.7346937500000001 17.78090625 1.596211875 17.7202125 1.469739375 17.65951875 1.3432668749999999 17.571225000000002 1.232026875 17.46181875 1.1442187499999998 17.352431250000002 1.056410625 17.22470625 0.99427125 17.088112499999998 0.9623849999999999 16.951500000000003 0.930496875 16.80946875 0.92967375 16.6725 0.9599737500000001l-15 3.3337575c-0.2083575 0.0460875 -0.394755 0.1618875 -0.52839375 0.32825625S0.9375843749999999 4.9953375 0.9375 5.20873125V39.791250000000005Z"
                                  stroke-width="3"></path>
                            <path fill="#e3bfb3"
                                  d="m8.4375 2.79001875 -6.764994375000001 1.5c-0.208985625 0.046218749999999996 -0.39586125 0.16258124999999998 -0.529569375 0.32971875 -0.13371 0.1671375 -0.20620125 0.37498125 -0.20543062499999998 0.58903125V39.791250000000005c0.000084375 0.213375 0.0729675 0.420375 0.20660625 0.5866875 0.13363875 0.1665 0.32003625 0.2821875 0.52839375 0.3283125L8.4375 42.206250000000004V2.79001875Z"
                                  stroke-width="3"></path>
                            <path stroke="#191919"
                                  stroke-linecap="round"
                                  stroke-linejoin="round"
                            ...
                            <path fill="#808080"
                                  ...
                                  stroke-linecap="round"
                                  stroke-linejoin="round"
                                  d="M11.25 25.3125c1.5533062499999999 0 2.8125 -1.25925 2.8125 -2.8125s-1.2591937500000001 -2.8125 -2.8125 -2.8125 -2.8125 1.25925 -2.8125 2.8125 1.2591937500000001 2.8125 2.8125 2.8125Z"
                                  stroke-width="3"></path>
                        </svg>
