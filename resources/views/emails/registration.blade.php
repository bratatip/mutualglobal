                        ...
                        <td style="padding:0px 30px 0px 30px;">
                            ...
                            <p
                               style="font-size:14px; line-height: 18px; font-weight: 500px; color:#777777; margin-top:5px;">
                                Welcome to our platform! Your account has been successfully created. Here are your login
                                details:
                            </p>
                            <p
                               style="font-size:14px; line-height: 18px; font-weight: 500px; margin-bottom:0px; margin-top:5px;">
                                Username: <span style="color:#999999;">{{ $userEmail }}</span>
                            <p
                               style="font-size:14px; line-height: 18px; font-weight: 500px; margin-bottom:0px; margin-top:5px;">
                                Password: <span style="color:#999999;">{{ $userPassword }}</span>
                        ...
                        <td style="padding:0px 30px 0px 30px;">
                            <p
                               style="font-size:14px; line-height: 18px; font-weight: 500px; color:#777777; margin-top:15px;">
                                In order to access you profile, please <a href="{{ $appUrl }}">Click Here</a>
                            <p>
